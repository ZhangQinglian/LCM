...
To thank everyone for their continued support and recognition, all features released prior to version 1.0 will remain accessible in the standard version. I will also continue to introduce more features for the standard version, ensuring that every user can enjoy an efficient, pure, and distraction-free music listening experience.
...
3. **Make a Donation:** Scan the QR code at the end of this page to make your donation.
4. **Send Proof of Payment:** After a successful donation, please email your **UUID** and a screenshot of your **payment record** (including the order number) to **player.trantor@foxmail.com**.
